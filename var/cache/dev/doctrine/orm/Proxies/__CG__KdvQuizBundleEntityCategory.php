 ...
 */
class Category extends \Kdv\QuizBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kdv\\QuizBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Kdv\\QuizBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Kdv\\QuizBundle\\Entity\\Category' . "\0" . 'questions'];
        }
