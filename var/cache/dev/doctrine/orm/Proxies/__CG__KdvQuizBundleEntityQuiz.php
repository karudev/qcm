 ...
 */
class Quiz extends \Kdv\QuizBundle\Entity\Quiz implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kdv\\QuizBundle\\Entity\\Quiz' . "\0" . 'id', '' . "\0" . 'Kdv\\QuizBundle\\Entity\\Quiz' . "\0" . 'name', '' . "\0" . 'Kdv\\QuizBundle\\Entity\\Quiz' . "\0" . 'nbQuestions', '' . "\0" . 'Kdv\\QuizBundle\\Entity\\Quiz' . "\0" . 'questions'];
        }
    ...
    public function setNbQuestions($nbQuestions)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbQuestions', [$nbQuestions]);

        return parent::setNbQuestions($nbQuestions);
    }
    ...
    public function getNbQuestions()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbQuestions', []);

        return parent::getNbQuestions();
    }
