...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'quiz', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Kdv/QuizBundle/Entity'))), 'Kdv\\QuizBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('KdvQuizBundle' => 'Kdv\\QuizBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ffd26fc6f60bd91a7780ff1d82666730e45c4004b268421aa1e97cf9a36eec15');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Kdv/QuizBundle/Resources/views'), 'KdvQuiz');
        $instance->addPath(($this->targetDirs[3].'/src/Kdv/EstheticQuizBundle/Resources/views'), 'KdvEstheticQuiz');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3e1492746c6ae2c29be97358e0f01a1a5da24b89');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56a15721f1f108.83097092')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'KdvQuizBundle' => 'Kdv\\QuizBundle\\KdvQuizBundle',
                'KdvEstheticQuizBundle' => 'Kdv\\EstheticQuizBundle\\KdvEstheticQuizBundle',
            ...
            'secret' => '3e1492746c6ae2c29be97358e0f01a1a5da24b89',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '3e1492746c6ae2c29be97358e0f01a1a5da24b89',
